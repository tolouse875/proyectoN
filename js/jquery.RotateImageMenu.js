			...
			var	timeDiff			= 300,
				...
				*/
					...
					$listItems.each(function(i) {
						...
						setTimeout(function() {
							...
							var	$otherImages		= $('#' + $item.data('images')).children('img'),
								...
								//the next image to show and its initial rotation (depends on dir) // Rotacion siguiente Item
								var otherRotation	= (dir === 1) ? '-45deg' : '45deg',
				...
				rotateMaskCorners	= function() {
					...
					$rm_corner_left.transform({rotate: '30deg'});
